...
declare module Immutable {
  ...
  export interface List<T> extends Collection.Indexed<T> {
    ...
    merge(...iterables: Iterator<T>[]): List<T>;
    ...
    mergeDeep(...iterables: Iterator<T>[]): List<T>;
  ...
  export interface Map<K, V> extends Collection.Keyed<K, V> {
    ...
    merge(...iterables: Iterator<[K, V]>[]): Map<K, V>;
    ...
    mergeDeep(...iterables: Iterator<[K, V]>[]): Map<K, V>;
  ...
  export interface Set<T> extends Collection.Set<T> {
    ...
    intersect(...iterables: Iterator<T>[]): Set<T>;
    ...
    subtract(...iterables: Iterator<T>[]): Set<T>;
  ...
  export interface Stack<T> extends Collection.Indexed<T> {
    ...
    unshiftAll(iter: Iterator<T>): Stack<T>;
    ...
    pushAll(iter: Iterator<T>): Stack<T>;
  ...
  export module Iterable {
    ...
    export interface Indexed<T> extends Iterable<number, T> {
      ...
      zip(...iterables: Array<Iterator<any>>): /*this*/Iterable.Indexed<any>;
